					...
					{{ csrf_field() }}
						...
						<fieldset>
							<div class="input-prepend" title="Email">
								...
								<input class="input-large span10" name="admin_email" id="admin_email" type="email" placeholder="Enter Email"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" id="admin_password" type="password" placeholder="Enter Password"/>
							</div>
							<div class="clearfix"></div>
