				...
				{{-- ============================ Category ====================== --}}
						...
						@foreach ($all_publication_status as $valueCat)						
							<div class="panel panel-default">
								...
								<h4 class="panel-title"><a href="{{URL::to('/show-product-by-cat/'.$valueCat->category_id)}}">{{$valueCat->category_name}}</a></h4>
								</div>
							</div>
						@endforeach
				{{-- ============================ Category End ====================== --}}
				...
				{{-- ============================ Manufacture ====================== --}}
						...
						@foreach ($all_publication_status as $valueManufacture)	
								<ul class="nav nav-pills nav-stacked">
									<li><a href="{{URL::to('/show-product-by-manufacture/'.$valueManufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$valueManufacture->manufacture_name}}</a></li>
								</ul>
						@endforeach
				{{-- ============================ Manufacture End ====================== --}}
							</div>
